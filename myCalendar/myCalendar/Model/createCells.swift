...
func createCells(_ cells: [CellContent]) -> [CellContent] {
    var cells2 = cells
    cells2.append(CellContent(content: "Deine Periode beginnt in\n5 Tagen", logo: #imageLiteral(resourceName: "Periode_Icon") , contentHighlighted: nil, contentAdd: nil, doneSwitch:  nil))
    ...
    cells2.append(CellContent(content: "Sex gehabt", logo: nil, contentHighlighted: nil, contentAdd: nil, doneSwitch: nil))
